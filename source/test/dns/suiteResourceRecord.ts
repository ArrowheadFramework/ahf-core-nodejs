...
export const suiteResourceRecord: unit.Suite = {
    name: "ResourceRecord",

    "Decode and encode PTR record": () => utils.readWriteAndCompare(
        Buffer.from([
            // 5 alpha
    ...
    "Decode and encode TSIG record": () => utils.readWriteAndCompare(
        Buffer.from([
            // 5 alpha
            0x05, 0x61, 0x6c, 0x70, 0x68, 0x61,
            // 9 arrowhead
